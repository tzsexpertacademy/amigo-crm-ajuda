...
const LoggedInLayout = ({ children, themeToggle }) => {
  ...
  const handleRefreshApi = async () => {
    toast.promise(
      ...
      {
        pending: "Um segundo, estamos reiniciando a API...",
        success: "API reiniciada com sucesso!",
        error: "Houve um problema ao reiniciar a API.",
      }
    );
  }
  ...
  return (
    <div className={classes.root}>
      ...
      <AppBar
        ...
        color="primary"
      >
        <Toolbar variant="dense" className={`${classes.toolbar} ${classes.toolbarScrollable}`}>
          ...
          <IconButton
            aria-label="Raio"
            onClick={() => {
              // Função para o clique no botão do raio
              handleRefreshApi()
            }}
            color="inherit"
          >

...
import UpdateContactServiceByApi from "../services/ContactServices/UpdateContactServiceByApi";
...
export const updateContactServiceByApiInController = (req: Request, res: Response): Promise<any> =>{
  
  const { companyId } = req.user;

  return UpdateContactServiceByApi({contactData: {...req.body}, companyId}, res);
}
